...
import categories from "../../assets/data/menuData";
import "./Header.scss";
    ...
    <header className="bg-white fixed top-0 w-full z-50 shadow-md">
      ...
      >
          ...
          <a href="#" className="-m-1.5 p-1">
            <div className="logo-div">
              ...
              <div className="text-div">
                <h1 className="">SOLES ON Wheels</h1>

                <p className="text2">The Backpacker's Hostel</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="#"
            className="text-md font-semibold leading-6 text-gray-900 pr-3 text-base"
          >
            Log in
          </a>
          <a href="#">
